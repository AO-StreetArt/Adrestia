...
$CURL_COMMAND -X PUT -d 'cache--6379----2--5--0' http://$CONSUL_HOST:8500/v1/kv/clyman/RedisConnectionString
...
$CURL_COMMAND -X PUT -d 'False' http://$CONSUL_HOST:8500/v1/kv/clyman/AtomicTransactions
