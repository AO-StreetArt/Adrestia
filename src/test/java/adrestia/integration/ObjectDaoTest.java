...
public class ObjectDaoTest {
  ...
  public void testObjectCrud() throws Exception {
    ...
    try {
      ...
      testLogger.println(getResp2.getDocuments()[0].getType().equals("TestType2"));
      testLogger.println(getResp2.getDocuments()[0].getOwner().equals("TestOwner2"));
      ...
      testLogger.println("Update Test Result: ");
      testLogger.println(ovrCheckResp.getDocuments()[0].getTransform()[0] - 1.0);
      testLogger.println(ovrCheckResp.getDocuments()[0].getTransform()[0] - 1.0);
