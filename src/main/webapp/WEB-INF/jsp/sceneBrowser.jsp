...
<html>
  ...
  <body>
    ...
    var eGridDiv = document.querySelector('#sceneGrid');
    ...
    function onButtonClick(event) {
      ...
      if (event.target.id == "query") {
        ...
        // TO-DO: This needs to make a scene list message, not just a scene
        query_params = {}
        if (queryKey) query_params["key"] = queryKey;
        if (queryCt) query_params["name"] = queryCt;
        if (queryFt) query_params["region"] = queryFt;
        if (queryAt) query_params["longitude"] = queryAt;
        if (queryAt) query_params["latitutde"] = queryAt;
        if (queryAt) query_params["distance"] = queryAt;
